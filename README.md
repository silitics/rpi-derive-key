...
📌 **Tip:** You should use different keys (with different info material) for different purposes like fetching configurations. That way, if a key for a given purpose is compromised, all other keys remain secure.
